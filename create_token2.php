            ...
            <div class="card-body">
                <form id="tokenForm">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            <label>RST No</label>
                            <input class="form-control" name="token_no" placeholder="Auto / Manual">
                        </div>
                        <div class="col-md-3">
                            <label>Challan No</label>
                            <input class="form-control" name="challan_no">
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            <label>Item</label>
                            <input class="form-control" name="item_name" value="RBT">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" step="0.01" class="form-control" name="gross_weight">
                        </div>
                        <div class="col-md-3">
                            <label>Gross Time (IST)</label>
                            <input type="datetime-local" class="form-control" name="gross_time" value="<?= $now ?>">
                        </div>
                        <div class="col-md-3">
                            <label>Tare Weight (KG)</label>
                            <input type="number" step="0.01" class="form-control" name="tare_weight">
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" name="charge_amount" value="200">
                        </div>
                    </div>
